...
Frontend адаптирован к backend-ответам. Каталог, список HR, импорт и completion
описаны в [backend-workflows](backend-workflows.md). Отдельный AI-адаптер подключает
траекторию, рекомендации и HR-аналитику: [career-workspace](career-workspace.md).
