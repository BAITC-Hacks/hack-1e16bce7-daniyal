...
Импорт в БД, бизнес-таблицы, вход/JWT, подключение AI к HTTP API и HR-аналитика — следующие этапы.
...
Пробное задание работает без API; для проверки подключения на HR-странице запустите backend.
...
На `/hr` проверить статус сервиса при запущенном и остановленном API.
