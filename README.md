...
Оба клиента проверяют готовность API и БД. Есть доменные модели и расчёт роста навыков.
Импорт, бизнес-таблицы, вход/JWT, scoring, OpenAI-объяснения и HR-аналитика — следующие этапы.
Стартовый HR-экран пока публичный и не содержит данных сотрудников.
